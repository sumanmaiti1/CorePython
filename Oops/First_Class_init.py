...
class Human(object):
    ...
    def __init__(self, name, surname, age) -> None:
        # --- This is an instance Variable. Value will be different for each of the objects created for this class ----
        self.name = name
...
# ---------------- Here we are changing the instance variables using object reference, i.e, outside of class -------

human1.age = 100
human2.name = "Beauty"

# ---------------- Here we are accessing  the instance variables using object reference --------------
print(f'My name is {human1.name} {human1.surname} and i am {human1.age} years old. Currently i am accessing instance variables using Objects of Human Class.')
print(f'My name is {human2.name} {human2.surname} and i am {human2.age} years old. Currently i am accessing instance variables using Objects of Human Class.')
